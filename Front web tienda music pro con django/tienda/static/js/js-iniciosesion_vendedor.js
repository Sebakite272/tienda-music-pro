...
form.addEventListener("submit", (e) => {
  ...
  if (emailIn === "john.alc@gmail.com") { //para iniciar sesion con vendedor
    redirectTo("sesion_iniciada_exito_vendedor"); 
  } else if (emailIn === "admin.p@gmail.com") { //para iniciar sesion con vendedor
    redirectTo("sesion_iniciada_exito_vendedor");
  } else {
